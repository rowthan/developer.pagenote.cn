...
export default function (props:{onClose:()=>void}) {
    ...
    return(
        <div className="relative flex items-center justify-center via-blue-600 to-sky-600">
            ...
            <div className="relative px-4 md:px-14 py-4 md:py-10 bg-gradient-to-br from-yellow-300 to-yellow-400 border-4 border-gray-900 flex items-center justify-center transform -skew-x-1">
                <div className="inline-block py-8 px-5 md:px-10 bg-white border-4 border-gray-900 text-center transform skew-x-2">
                    {
                        paid ? <div>
                            请稍后，我将尽快确认并绑定；
                        </div>:
                          ...
                          PAGENOTE
                                ...
                                <button onClick={()=>{setPaid(true)}} className="bg-red-500 hover:bg-red-600 text-white py-2 px-10 border-2 border-gray-900 mt-5 font-bold -skew-x-2">
                                    支付好了
                                </button>
                            </div>
                    }
