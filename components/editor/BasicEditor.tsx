...
function RichTextExample(props: Props, ref: { current: Editor | null }) {
  ...
  // let value =  initialValue ? initialValue : htmlToSlate(html||" ");
  // value = value.length > 0 ? value : [{type:"paragraph",children: [{text: ''}]}]
  // console.log(value,initialValue,'render',html)
...
export default forwardRef(RichTextExample)
