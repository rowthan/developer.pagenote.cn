                        ...
                        <div className="w-full md:w-3/12 md:mx-2">
                            <div className="bg-white p-3 border-t-4 border-green-400">
                                <div className="image overflow-hidden relative group">
                                    <div className={'h-auto w-full mx-auto aspect-w-16 aspect-h-16'}>
                                        <img className="h-auto w-full h-full mx-auto  object-cover"
                                             src={newImg||img}
                                             alt=""/>
                                    </div>
                                    <div className={'absolute w-full -bottom-10 group-hover:bottom-0 duration-150 transition-all'}>
                                        <UploadTrigger onChange={(url)=>{onChange({avatar:url})}}>
                                ...
                                <ul
                                    className="bg-gray-100 text-gray-700  hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
