import { SERVER_WEB_HOST } from 'site.config'

const  GITHUB_AUTH_CALLBACK = SERVER_WEB_HOST + '/oauth/callback_github'
 const    NOTION_AUTH_CALLBACK = SERVER_WEB_HOST + '/oauth/callback_notion'
...
export const AuthConfig: Record<AuthType, {
    label: string,
    link: string,
    icon: string,
    platformUrl: string,
